...
This simple app demonstrates how easy to use is the Firekast Android SDK.

1. Git clone this project
2. Modify `App.kt` with your credentials. *Visit our dashboard if you don't have yet.*
